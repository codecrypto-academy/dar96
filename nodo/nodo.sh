...
# Remove existing Docker containers and networks, true is for ignore errors
...
# Create the necessary directory structure, -p is for creating networks directory and everything else after /, in this case bwsu-network directory
